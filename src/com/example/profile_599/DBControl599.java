...
public class DBControl599 extends SQLiteOpenHelper{
	String strName,strBrithday,strEmail, intAge,intHeight,intWeight;
	private static final String DATABASE_NAME ="onwara";
	private static final  String TABLE_REGITER="data";
	private static final int DATABASE_VERSION= 1 ;

	public DBControl599(Context context) {
